...
class TierResponse(BaseModel):
    ...
    limits: Optional[TierResponseLimits] = None
    features: Optional[TierResponseFeatures] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "title", "description", "price_cents", "currency", "limits", "features"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "limits": TierResponseLimits.from_dict(obj["limits"]) if obj.get("limits") is not None else None,
            "features": TierResponseFeatures.from_dict(obj["features"]) if obj.get("features") is not None else None
        })
