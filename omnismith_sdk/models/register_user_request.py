...
class RegisterUserRequest(BaseModel):
    ...
    password: SecretStr = Field(description="User password (min 8 chars)")
    captcha_token: Optional[StrictStr] = Field(default=None, description="CAPTCHA response token (required for anonymous/public signups)", alias="captchaToken")
