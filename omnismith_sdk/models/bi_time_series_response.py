...
class BiTimeSeriesResponse(BaseModel):
    """
    Flat time-series dataset for BI tooling
    """ # noqa: E501
    data: Optional[List[BiTimeSeriesRow]] = Field(default=None, description="List of flat time-bucketed metric observations")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [BiTimeSeriesRow.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
