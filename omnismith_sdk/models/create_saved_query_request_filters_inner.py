...
class CreateSavedQueryRequestFiltersInner(BaseModel):
    """
    CreateSavedQueryRequestFiltersInner
    """ # noqa: E501
    var_field: Optional[UUID] = Field(default=None, alias="field")
    ...
    def operator_validate_enum(cls, value):
        ...
        if value not in set(['eq', 'gt', 'lt', 'like', 'empty', 'not-empty']):
            raise ValueError("must be one of enum values ('eq', 'gt', 'lt', 'like', 'empty', 'not-empty')")
        return value
