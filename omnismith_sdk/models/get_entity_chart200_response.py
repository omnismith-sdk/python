...
class GetEntityChart200Response(BaseModel):
    """
    GetEntityChart200Response
    """ # noqa: E501
    series: Optional[List[GetEntityChart200ResponseSeriesInner]] = Field(default=None, description="List of aggregated metric series")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "series": [GetEntityChart200ResponseSeriesInner.from_dict(_item) for _item in obj["series"]] if obj.get("series") is not None else None
        })
