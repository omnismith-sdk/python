...
class SetListItemsRequest(BaseModel):
    """
    Payload containing the full replacement set of choice option items for a List-type attribute.
    """ # noqa: E501
    items: List[ListItemInput] = Field(description="Array of list item specifications to set.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [ListItemInput.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None
        })
