...
class UpdateNotificationChannelRequest(BaseModel):
    ...
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="Updated display name of the notification channel")
    credentials: Optional[UpdateNotificationChannelRequestCredentials] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["name", "credentials"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "name": obj.get("name"),
            "credentials": UpdateNotificationChannelRequestCredentials.from_dict(obj["credentials"]) if obj.get("credentials") is not None else None
        })
