...
class CreateWorkspaceViewRequestSort(BaseModel):
    """
    Active sort configuration defining target field and direction
    """ # noqa: E501
    active: Optional[StrictStr] = Field(default=None, description="Attribute key (UUID or slug) or system column to sort by")
    direction: Optional[StrictStr] = Field(default=None, description="Sort ordering direction")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["active", "direction"]
