...
class GetJwks200Response(BaseModel):
    ...
    GetJwks200Response
    """ # noqa: E501
    keys: Optional[List[GetJwks200ResponseKeysInner]] = Field(default=None, description="Array of public cryptographic key descriptors")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "keys": [GetJwks200ResponseKeysInner.from_dict(_item) for _item in obj["keys"]] if obj.get("keys") is not None else None
        })
