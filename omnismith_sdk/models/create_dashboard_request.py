...
class CreateDashboardRequest(BaseModel):
    ...
    """ # noqa: E501
    name: StrictStr = Field(description="Display name of the dashboard")
    description: Optional[StrictStr] = Field(default=None, description="Detailed description of the dashboard purpose and telemetry scope")
    config: Optional[CreateDashboardRequestConfig] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "config": CreateDashboardRequestConfig.from_dict(obj["config"]) if obj.get("config") is not None else None
        })
