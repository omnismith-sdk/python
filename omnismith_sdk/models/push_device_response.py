...
class PushDeviceResponse(BaseModel):
    ...
    """ # noqa: E501
    id: Optional[UUID] = Field(default=None, description="Unique device token record UUID")
    token: Optional[StrictStr] = Field(default=None, description="FCM device registration token (masked for security)")
    device_name: Optional[StrictStr] = Field(default=None, description="Optional user-assigned or hardware device name")
    created_at: Optional[datetime] = Field(default=None, description="Registration timestamp")
    updated_at: Optional[datetime] = Field(default=None, description="Last update timestamp")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "token", "device_name", "created_at", "updated_at"]
