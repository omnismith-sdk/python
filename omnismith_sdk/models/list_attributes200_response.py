...
class ListAttributes200Response(BaseModel):
    """
    ListAttributes200Response
    """ # noqa: E501
    data: Optional[List[AttributeResponse]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [AttributeResponse.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
