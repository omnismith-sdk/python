...
class IngestMetricsRequest(BaseModel):
    ...
    """ # noqa: E501
    metric_values: Optional[List[IngestMetricsRequestMetricValuesInner]] = Field(default=None, description="List of metric attribute observations to ingest")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["metric_values"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "metric_values": [IngestMetricsRequestMetricValuesInner.from_dict(_item) for _item in obj["metric_values"]] if obj.get("metric_values") is not None else None
        })
