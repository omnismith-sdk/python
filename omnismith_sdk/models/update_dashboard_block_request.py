...
class UpdateDashboardBlockRequest(BaseModel):
    """
    Payload for updating a dashboard block configuration, query parameters, or 12-column grid placement
    """ # noqa: E501
    title: Optional[StrictStr] = Field(default=None, description="Updated display title for the widget card header")
    config: Optional[UpdateDashboardBlockRequestConfig] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["title", "config"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "title": obj.get("title"),
            "config": UpdateDashboardBlockRequestConfig.from_dict(obj["config"]) if obj.get("config") is not None else None
        })
