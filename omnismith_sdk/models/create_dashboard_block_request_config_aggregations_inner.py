...
class CreateDashboardBlockRequestConfigAggregationsInner(BaseModel):
    """
    CreateDashboardBlockRequestConfigAggregationsInner
    """ # noqa: E501
    op: Optional[StrictStr] = None
    var_field: Optional[StrictStr] = Field(default=None, description="Attribute slug or UUID to reduce. Required for every op except count, which must omit it.", alias="field")
