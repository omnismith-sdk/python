...
class RegisterPushDeviceRequest(BaseModel):
    ...
    """ # noqa: E501
    token: StrictStr = Field(description="FCM device registration token")
    device_name: Optional[StrictStr] = Field(default=None, description="Optional device name for identification")
