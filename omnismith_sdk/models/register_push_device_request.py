...
class RegisterPushDeviceRequest(BaseModel):
    ...
    """ # noqa: E501
    token: StrictStr = Field(description="Firebase Cloud Messaging (FCM) device registration token generated by client SDK")
    device_name: Optional[StrictStr] = Field(default=None, description="Optional user-friendly device name for identification")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["token", "device_name"]
