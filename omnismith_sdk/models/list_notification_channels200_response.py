...
class ListNotificationChannels200Response(BaseModel):
    """
    ListNotificationChannels200Response
    """ # noqa: E501
    data: Optional[List[NotificationChannelResponse]] = Field(default=None, description="Array of notification channels")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [NotificationChannelResponse.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
