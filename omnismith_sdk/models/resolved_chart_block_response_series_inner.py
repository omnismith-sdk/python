...
class ResolvedChartBlockResponseSeriesInner(BaseModel):
    ...
    data_points: Optional[List[GetEntityChart200ResponseSeriesInnerDataInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data_points": [GetEntityChart200ResponseSeriesInnerDataInner.from_dict(_item) for _item in obj["data_points"]] if obj.get("data_points") is not None else None
        })
