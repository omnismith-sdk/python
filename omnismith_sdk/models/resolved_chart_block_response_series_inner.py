...
class ResolvedChartBlockResponseSeriesInner(BaseModel):
    """
    ResolvedChartBlockResponseSeriesInner
    """ # noqa: E501
    entity_id: Optional[UUID] = Field(default=None, description="Entity unique identifier")
    entity_name: Optional[StrictStr] = Field(default=None, description="Resolved display name of the entity")
    data_points: Optional[List[ResolvedChartBlockResponseSeriesInnerDataPointsInner]] = Field(default=None, description="Ordered array of time-bucketed metric points")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["entity_id", "entity_name", "data_points"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data_points": [ResolvedChartBlockResponseSeriesInnerDataPointsInner.from_dict(_item) for _item in obj["data_points"]] if obj.get("data_points") is not None else None
        })
