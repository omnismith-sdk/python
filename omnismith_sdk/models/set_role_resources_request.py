...
class SetRoleResourcesRequest(BaseModel):
    """
    SetRoleResourcesRequest
    """ # noqa: E501
    resources: List[ResourceAccessInput]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "resources": [ResourceAccessInput.from_dict(_item) for _item in obj["resources"]] if obj.get("resources") is not None else None
        })
