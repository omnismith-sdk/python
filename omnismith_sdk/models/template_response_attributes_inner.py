...
class TemplateResponseAttributesInner(BaseModel):
    """
    TemplateResponseAttributesInner
    """ # noqa: E501
    attribute_id: UUID = Field(description="Attribute UUID")
    default_value: Optional[StrictStr] = Field(default=None, description="Per-template default value for newly created entities (or null). For List attributes, stores the list item UUID.")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["attribute_id", "default_value"]
