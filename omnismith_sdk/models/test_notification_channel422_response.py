...
class TestNotificationChannel422Response(BaseModel):
    """
    TestNotificationChannel422Response
    """ # noqa: E501
    success: Optional[StrictBool] = Field(default=None, description="Indicates test delivery failed")
    error: Optional[StrictStr] = Field(default=None, description="Failure error message")
