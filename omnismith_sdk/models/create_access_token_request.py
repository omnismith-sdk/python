...
class CreateAccessTokenRequest(BaseModel):
    ...
    """ # noqa: E501
    name: StrictStr = Field(description="Friendly human-readable label to identify the token purpose")
    expires_at: datetime = Field(description="Expiration timestamp in ISO 8601 UTC format (e.g. 2026-12-31T23:59:59Z)")
