...
class CreateDashboardBlockRequestConfigFiltersInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["field", "operator", "value", "is_active"]

    @field_validator('operator')
    def operator_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['eq', 'neq', 'gt', 'gte', 'lt', 'lte', 'contains', 'in']):
            raise ValueError("must be one of enum values ('eq', 'neq', 'gt', 'gte', 'lt', 'lte', 'contains', 'in')")
        return value
