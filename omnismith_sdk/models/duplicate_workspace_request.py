...
class DuplicateWorkspaceRequest(BaseModel):
    ...
    """ # noqa: E501
    new_name: Optional[StrictStr] = Field(default=None, description="Custom name for the duplicated workspace; if omitted, defaults to the source name with a (Copy) suffix")
