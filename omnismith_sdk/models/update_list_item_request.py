...
class UpdateListItemRequest(BaseModel):
    ...
    """ # noqa: E501
    value: StrictStr = Field(description="Updated display value / label for this list item.")
    sort_order: Optional[StrictInt] = Field(default=0, description="Updated display sorting rank (lower numbers appear first).")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["value", "sort_order"]
