...
class ReorderWorkspaceViewsRequest(BaseModel):
    """
    Payload containing the reordered list of workspace view IDs
    """ # noqa: E501
    view_ids: List[UUID] = Field(description="Ordered array of view unique identifiers (UUIDs) defining the new pane sequence")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["view_ids"]
