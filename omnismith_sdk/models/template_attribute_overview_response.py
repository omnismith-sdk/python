...
class TemplateAttributeOverviewResponse(BaseModel):
    """
    Template attribute association with optional per-template default value.
    """ # noqa: E501
    id: UUID = Field(description="Attribute UUID")
    slug: Optional[StrictStr] = Field(default=None, description="Attribute slug identifier")
    default_value: Optional[StrictStr] = Field(default=None, description="Per-template default value for newly created entities")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "slug", "default_value"]
