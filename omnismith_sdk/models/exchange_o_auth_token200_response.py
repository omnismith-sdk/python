...
class ExchangeOAuthToken200Response(BaseModel):
    """
    ExchangeOAuthToken200Response
    """ # noqa: E501
    access_token: Optional[StrictStr] = Field(default=None, description="RS256 JWT access token")
    token_type: Optional[StrictStr] = Field(default=None, description="Token type (Bearer)")
    expires_in: Optional[StrictInt] = Field(default=None, description="Access token lifetime in seconds")
    refresh_token: Optional[StrictStr] = Field(default=None, description="Rotating refresh token for renewing credentials")
    scope: Optional[StrictStr] = Field(default=None, description="Granted scope strings")
