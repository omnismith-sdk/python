...
class UpdateEntityRequest(BaseModel):
    ...
    """ # noqa: E501
    attribute_values: Optional[List[UpdateEntityRequestAttributeValuesInner]] = Field(default=None, description="List of attribute value mutations to apply")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["attribute_values"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "attribute_values": [UpdateEntityRequestAttributeValuesInner.from_dict(_item) for _item in obj["attribute_values"]] if obj.get("attribute_values") is not None else None
        })
