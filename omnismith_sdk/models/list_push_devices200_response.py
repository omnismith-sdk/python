...
class ListPushDevices200Response(BaseModel):
    """
    ListPushDevices200Response
    """ # noqa: E501
    data: Optional[List[PushDeviceResponse]] = Field(default=None, description="Array of registered push devices")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [PushDeviceResponse.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
