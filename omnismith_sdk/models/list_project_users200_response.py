...
class ListProjectUsers200Response(BaseModel):
    """
    ListProjectUsers200Response
    """ # noqa: E501
    data: Optional[List[ProjectUserResponse]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [ProjectUserResponse.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
