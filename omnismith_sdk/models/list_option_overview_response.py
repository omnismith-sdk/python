...
class ListOptionOverviewResponse(BaseModel):
    """
    Selectable choice option for a list attribute.
    """ # noqa: E501
    id: UUID = Field(description="List option UUID")
    value: StrictStr = Field(description="Option display value / choice label")
