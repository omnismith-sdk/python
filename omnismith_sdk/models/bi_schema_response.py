...
class BiSchemaResponse(BaseModel):
    ...
    """ # noqa: E501
    templates: Optional[List[BiTemplateInfo]] = Field(default=None, description="List of template schemas available for BI integration")
    fields: Optional[List[BiSchemaField]] = Field(default=None, description="Normalized field definitions across all templates with type mappings")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["templates", "fields"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "templates": [BiTemplateInfo.from_dict(_item) for _item in obj["templates"]] if obj.get("templates") is not None else None,
            "fields": [BiSchemaField.from_dict(_item) for _item in obj["fields"]] if obj.get("fields") is not None else None
        })
