...
class AggregateEntitiesGroupAggregatesInner(BaseModel):
    """
    AggregateEntitiesGroupAggregatesInner
    """ # noqa: E501
    op: StrictStr
    var_field: Optional[StrictStr] = Field(description="The aggregation field as sent; null for count", alias="field")
    value: Optional[AggregateEntitiesGroupAggregatesInnerValue]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "op": obj.get("op"),
            "field": obj.get("field"),
            "value": AggregateEntitiesGroupAggregatesInnerValue.from_dict(obj["value"]) if obj.get("value") is not None else None
        })
