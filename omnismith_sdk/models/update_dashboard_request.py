...
class UpdateDashboardRequest(BaseModel):
    ...
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="Updated display name of the dashboard")
    description: Optional[StrictStr] = Field(default=None, description="Updated description of the dashboard purpose and telemetry scope")
    config: Optional[UpdateDashboardRequestConfig] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "config": UpdateDashboardRequestConfig.from_dict(obj["config"]) if obj.get("config") is not None else None
        })
