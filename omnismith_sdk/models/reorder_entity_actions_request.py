...
class ReorderEntityActionsRequest(BaseModel):
    """
    ReorderEntityActionsRequest
    """ # noqa: E501
    ids: List[UUID] = Field(description="Every action UUID of the template, first to last. Omitting or repeating one is rejected with 422.")
