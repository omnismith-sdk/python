...
class UpdateProjectRequest(BaseModel):
    ...
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="Updated display name of the project")
    description: Optional[StrictStr] = Field(default=None, description="Updated description or context guidelines for the project. Pass null to clear.")
