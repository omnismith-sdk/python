...
class UserApi:
    ...
    def confirm_user_email(
        self,
        token: Annotated[StrictStr, Field(description="The email confirmation token received via email")],
        ...
        :param token: The email confirmation token received via email (required)
        :type token: str
