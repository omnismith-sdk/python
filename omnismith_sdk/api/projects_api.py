...
class ProjectsApi:
    ...
    def delete_project(
        self,
        id: Annotated[UUID, Field(description="Project ID to delete")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
    ...
    def dismiss_project_tour(
        self,
        id: Annotated[UUID, Field(description="Unique UUID identifier of the project")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param id: Unique UUID identifier of the project (required)
        :type id: UUID
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
    ...
    def remove_user_from_project(
        self,
        id: Annotated[UUID, Field(description="Project ID")],
        user_id: Annotated[UUID, Field(description="User ID to remove from project")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param id: Project ID (required)
        :type id: UUID
        :param user_id: User ID to remove from project (required)
        :type user_id: UUID
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
