...
if __import__("typing").TYPE_CHECKING:
    ...
    from omnismith_sdk.api.audit_log_api import AuditLogApi
    ...
    from omnismith_sdk.api.bi_api import BIApi
    ...
    from omnismith_sdk.api.workspaces_api import WorkspacesApi
