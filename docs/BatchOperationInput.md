...
json = "{}"
# create an instance of BatchOperationInput from a JSON string
batch_operation_input_instance = BatchOperationInput.from_json(json)
# print the JSON string representation of the object
print(BatchOperationInput.to_json())

# convert the object into a dict
batch_operation_input_dict = batch_operation_input_instance.to_dict()
# create an instance of BatchOperationInput from a dict
batch_operation_input_from_dict = BatchOperationInput.from_dict(batch_operation_input_dict)
```
