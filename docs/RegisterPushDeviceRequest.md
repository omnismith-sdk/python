...
------------ | ------------- | ------------- | -------------
**token** | **str** | Firebase Cloud Messaging (FCM) device registration token generated by client SDK | 
**device_name** | **str** | Optional user-friendly device name for identification | [optional] 
