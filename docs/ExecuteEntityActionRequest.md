...
execute_entity_action_request_instance = ExecuteEntityActionRequest.from_json(json)
# print the JSON string representation of the object
print(ExecuteEntityActionRequest.to_json())

# convert the object into a dict
execute_entity_action_request_dict = execute_entity_action_request_instance.to_dict()
# create an instance of ExecuteEntityActionRequest from a dict
execute_entity_action_request_from_dict = ExecuteEntityActionRequest.from_dict(execute_entity_action_request_dict)
```
