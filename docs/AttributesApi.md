...
[**get_project_schema**](AttributesApi.md#get_project_schema) | **GET** /discovery/project-schema | Get complete project schema
...
with omnismith_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of AttributesApi->get_project_schema:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling AttributesApi->get_project_schema: %s\n" % e)
```
